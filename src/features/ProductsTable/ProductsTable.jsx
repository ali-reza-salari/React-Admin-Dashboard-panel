...
export default function ProductsTable({  }) {
    ...
    const handelSearch = (event) => {
        ...
        setSearchResult(searchInputValue)

        startTransition(() => {
            const filterProducts = productsData.filter(product => product.product_title.toLowerCase().includes(searchInputValue.toLowerCase()))
